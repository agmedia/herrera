<?php
	...
	$export_pdf_basic_details .= "<td colspan='3' align='center'>".$this->language->get('text_report_date').": ".date($this->config->get('advpp' . $user_id . '_hour_format') == '24' ? "Y-m-d H:i:s" : "Y-m-d h:i:s A")."</td><td></td></tr>";
	$export_pdf_basic_details .="<tr>";
	...
	in_array('cm_orders', $advpp_settings_cm_columns) ? $export_pdf_basic_details .= "<td align='right'>".$this->language->get('column_orders')."</td>" : '';
	in_array('cm_customers', $advpp_settings_cm_columns) ? $export_pdf_basic_details .= "<td align='right'>".$this->language->get('column_customers')."</td>" : '';
	in_array('cm_sold_quantity', $advpp_settings_cm_columns) ? $export_pdf_basic_details .= "<td align='right'>".$this->language->get('column_sold_quantity')."</td>" : '';
	in_array('cm_sold_percent', $advpp_settings_cm_columns) ? $export_pdf_basic_details .= "<td align='right'>".$this->language->get('column_sold_percent')."</td>" : '';
	in_array('cm_total_excl_vat', $advpp_settings_cm_columns) ? $export_pdf_basic_details .= "<td align='right'>".$this->language->get('column_prod_total_excl_vat')."</td>" : '';
	in_array('cm_total_tax', $advpp_settings_cm_columns) ? $export_pdf_basic_details .= "<td align='right'>".$this->language->get('column_total_tax')."</td>" : '';
	in_array('cm_total_incl_vat', $advpp_settings_cm_columns) ? $export_pdf_basic_details .= "<td align='right'>".$this->language->get('column_prod_total_incl_vat')."</td>" : '';
	in_array('cm_app', $advpp_settings_cm_columns) ? $export_pdf_basic_details .= "<td align='right'>".$this->language->get('column_app')."</td>" : '';
	in_array('cm_refunds', $advpp_settings_cm_columns) ? $export_pdf_basic_details .= "<td align='right'>".$this->language->get('column_product_refunds')."</td>" : '';
	in_array('cm_reward_points', $advpp_settings_cm_columns) ? $export_pdf_basic_details .= "<td align='right'>".$this->language->get('column_product_reward_points')."</td>" : '';
	} elseif ($filter_report == 'products_options') {
	$export_pdf_basic_details .= "<td align='left'>".$this->language->get('column_prod_option')."</td>";
	in_array('mv_orders', $advpp_settings_mv_columns) ? $export_pdf_basic_details .= "<td align='right'>".$this->language->get('column_orders')."</td>" : '';
	in_array('mv_customers', $advpp_settings_mv_columns) ? $export_pdf_basic_details .= "<td align='right'>".$this->language->get('column_customers')."</td>" : '';
	...
	in_array('mv_upc', $advpp_settings_mv_columns) ? $export_pdf_basic_details .= "<td align='left'>".$this->language->get('column_upc')."</td>" : '';
	in_array('mv_ean', $advpp_settings_mv_columns) ? $export_pdf_basic_details .= "<td align='left'>".$this->language->get('column_ean')."</td>" : '';
	in_array('mv_jan', $advpp_settings_mv_columns) ? $export_pdf_basic_details .= "<td align='left'>".$this->language->get('column_jan')."</td>" : '';
	in_array('mv_isbn', $advpp_settings_mv_columns) ? $export_pdf_basic_details .= "<td align='left'>".$this->language->get('column_isbn')."</td>" : '';
	in_array('mv_mpn', $advpp_settings_mv_columns) ? $export_pdf_basic_details .= "<td align='left'>".$this->language->get('column_mpn')."</td>" : '';
	...
	in_array('mv_total_excl_vat', $advpp_settings_mv_columns) ? $export_pdf_basic_details .= "<td align='right'>".$this->language->get('column_prod_total_excl_vat')."</td>" : '';
	...
	in_array('mv_total_incl_vat', $advpp_settings_mv_columns) ? $export_pdf_basic_details .= "<td align='right'>".$this->language->get('column_prod_total_incl_vat')."</td>" : '';
	in_array('mv_app', $advpp_settings_mv_columns) ? $export_pdf_basic_details .= "<td align='right'>".$this->language->get('column_app')."</td>" : '';
	...
	in_array('cm_orders', $advpp_settings_cm_columns) ? $export_pdf_basic_details .= "<td align='right' nowrap='nowrap'>".$result['orders']."</td>" : '';
	in_array('cm_customers', $advpp_settings_cm_columns) ? $export_pdf_basic_details .= "<td align='right' nowrap='nowrap'>".$result['customers']."</td>" : '';
	in_array('cm_sold_quantity', $advpp_settings_cm_columns) ? $export_pdf_basic_details .= "<td align='right' nowrap='nowrap' style='background-color:#FFC;'>".$result['sold_quantity']."</td>" : '';
	in_array('cm_sold_percent', $advpp_settings_cm_columns) ? $export_pdf_basic_details .= "<td align='right' nowrap='nowrap' style='background-color:#FFC;'>".($result['sold_quantity'] != 0 ? round(100 * ($result['sold_quantity'] / $result['sold_quantity_total']), 2) : 0) . '%'."</td>" : '';
	in_array('cm_total_excl_vat', $advpp_settings_cm_columns) ? $export_pdf_basic_details .= "<td align='right' nowrap='nowrap'>".$result['total_excl_vat']."</td>" : '';
	in_array('cm_total_tax', $advpp_settings_cm_columns) ? $export_pdf_basic_details .= "<td align='right' nowrap='nowrap'>".$result['total_tax']."</td>" : '';
	in_array('cm_total_incl_vat', $advpp_settings_cm_columns) ? $export_pdf_basic_details .= "<td align='right' nowrap='nowrap'>".$result['total_incl_vat']."</td>" : '';
	in_array('cm_app', $advpp_settings_cm_columns) ? $export_pdf_basic_details .= "<td align='right' nowrap='nowrap'>".$result['app']."</td>" : '';
	in_array('cm_refunds', $advpp_settings_cm_columns) ? $export_pdf_basic_details .= "<td align='right' nowrap='nowrap'>".$result['refunds']."</td>" : '';
	in_array('cm_reward_points', $advpp_settings_cm_columns) ? $export_pdf_basic_details .= "<td align='right' nowrap='nowrap'>".$result['reward_points']."</td>" : '';
	} elseif ($filter_report == 'products_options') {
	$export_pdf_basic_details .= "<td align='left'>".$result['option_name']."</td>";
	in_array('mv_orders', $advpp_settings_mv_columns) ? $export_pdf_basic_details .= "<td align='right'>".$result['orders']."</td>" : '';
	in_array('mv_customers', $advpp_settings_mv_columns) ? $export_pdf_basic_details .= "<td align='right'>".$result['customers']."</td>" : '';
	...
	in_array('mv_upc', $advpp_settings_mv_columns) ? $export_pdf_basic_details .= "<td align='left'>".$result['upc']."</td>" : '';
	in_array('mv_ean', $advpp_settings_mv_columns) ? $export_pdf_basic_details .= "<td align='left'>".$result['ean']."</td>" : '';
	in_array('mv_jan', $advpp_settings_mv_columns) ? $export_pdf_basic_details .= "<td align='left'>".$result['jan']."</td>" : '';
	in_array('mv_isbn', $advpp_settings_mv_columns) ? $export_pdf_basic_details .= "<td align='left'>".$result['isbn']."</td>" : '';
	in_array('mv_mpn', $advpp_settings_mv_columns) ? $export_pdf_basic_details .= "<td align='left'>".$result['mpn']."</td>" : '';
	...
	in_array('mv_price', $advpp_settings_mv_columns) ? $export_pdf_basic_details .= "<td align='right' nowrap='nowrap'>".$result['price']."" : '';
	if ($filter_report == 'products_purchased_with_options' or $filter_report == 'products_abandoned_orders') {
	if ($result['option']) {
	foreach ($result['option'] as $option) {
	in_array('mv_price', $advpp_settings_mv_columns) ? $export_pdf_basic_details .= "<br /><small>".$option['fprice']."</small>" : '';		
	}
	}
	}	
	in_array('mv_price', $advpp_settings_mv_columns) ? $export_pdf_basic_details .= "</td>" : '';
	in_array('mv_stock_quantity', $advpp_settings_mv_columns) ? $export_pdf_basic_details .= "<td align='right'>".$result['stock_quantity']."" : '';
	if ($filter_report == 'products_purchased_with_options' or $filter_report == 'products_abandoned_orders') {
	if ($result['option']) {
	foreach ($result['option'] as $option) {
	in_array('mv_stock_quantity', $advpp_settings_mv_columns) ? $export_pdf_basic_details .= "<br /><small>".$option['quantity']."</small>" : '';		
	}
	}
	}	
	in_array('mv_stock_quantity', $advpp_settings_mv_columns) ? $export_pdf_basic_details .= "</td>" : '';
	if ($filter_report != 'products_abandoned_orders') {
	in_array('mv_orders', $advpp_settings_mv_columns) ? $export_pdf_basic_details .= "<td align='right' nowrap='nowrap'>".$result['orders']."</td>" : '';
	} else {
	in_array('mv_orders', $advpp_settings_mv_columns) ? $export_pdf_basic_details .= "<td align='right' nowrap='nowrap' style='text-decoration:line-through;'>".$result['orders']."</td>" : '';
	}
	if ($filter_report != 'products_abandoned_orders') {
	in_array('mv_customers', $advpp_settings_mv_columns) ? $export_pdf_basic_details .= "<td align='right' nowrap='nowrap'>".$result['customers']."</td>" : '';
	} else {
	in_array('mv_customers', $advpp_settings_mv_columns) ? $export_pdf_basic_details .= "<td align='right' nowrap='nowrap' style='text-decoration:line-through;'>".$result['customers']."</td>" : '';
	}
	if ($filter_report != 'products_abandoned_orders') {
	...
	in_array('mv_sold_quantity', $advpp_settings_mv_columns) ? $export_pdf_basic_details .= "<td align='right' nowrap='nowrap' style='background-color:#FFC; text-decoration:line-through;'>".$result['sold_quantity']."</td>" : '';
	}
	if ($filter_report != 'products_abandoned_orders') {
	in_array('mv_sold_percent', $advpp_settings_mv_columns) ? $export_pdf_basic_details .= "<td align='right' nowrap='nowrap' style='background-color:#FFC;'>".($result['sold_quantity'] != 0 ? round(100 * ($result['sold_quantity'] / $result['sold_quantity_total']), 2) : 0) . '%'."</td>" : '';
	} else {
	in_array('mv_sold_percent', $advpp_settings_mv_columns) ? $export_pdf_basic_details .= "<td align='right' nowrap='nowrap' style='background-color:#FFC; text-decoration:line-through;'>".($result['sold_quantity'] != 0 ? round(100 * ($result['sold_quantity'] / $result['sold_quantity_total']), 2) : 0) . '%'."</td>" : '';
	}	
	if ($filter_report != 'products_abandoned_orders') {	
	...
	in_array('mv_total_excl_vat', $advpp_settings_mv_columns) ? $export_pdf_basic_details .= "<td align='right' nowrap='nowrap' style='text-decoration:line-through;'>".$result['total_excl_vat']."</td>" : '';
	}
	if ($filter_report != 'products_abandoned_orders') {	
	...
	in_array('mv_total_tax', $advpp_settings_mv_columns) ? $export_pdf_basic_details .= "<td align='right' nowrap='nowrap' style='text-decoration:line-through;'>".$result['total_tax']."</td>" : '';
	}		
	if ($filter_report != 'products_abandoned_orders') {		
	...
	in_array('mv_total_incl_vat', $advpp_settings_mv_columns) ? $export_pdf_basic_details .= "<td align='right' nowrap='nowrap' style='text-decoration:line-through;'>".$result['total_incl_vat']."</td>" : '';
	}
	if ($filter_report != 'products_abandoned_orders') {	
	in_array('mv_app', $advpp_settings_mv_columns) ? $export_pdf_basic_details .= "<td align='right' nowrap='nowrap'>".$result['app']."</td>" : '';
	} else {
	in_array('mv_app', $advpp_settings_mv_columns) ? $export_pdf_basic_details .= "<td align='right' nowrap='nowrap' style='text-decoration:line-through;'>".$result['app']."</td>" : '';
	}	
	if ($filter_report != 'products_abandoned_orders') {		
	in_array('mv_refunds', $advpp_settings_mv_columns) ? $export_pdf_basic_details .= "<td align='right' nowrap='nowrap'>".$result['refunds']."</td>" : '';
	} else {
	in_array('mv_refunds', $advpp_settings_mv_columns) ? $export_pdf_basic_details .= "<td align='right' nowrap='nowrap' style='text-decoration:line-through;'>".$result['refunds']."</td>" : '';
	}	
	if ($filter_report != 'products_abandoned_orders') {		
	in_array('mv_reward_points', $advpp_settings_mv_columns) ? $export_pdf_basic_details .= "<td align='right' nowrap='nowrap'>".$result['reward_points']."</td>" : '';
	} else {
	in_array('mv_reward_points', $advpp_settings_mv_columns) ? $export_pdf_basic_details .= "<td align='right' nowrap='nowrap' style='text-decoration:line-through;'>".$result['reward_points']."</td>" : '';
	}
	}
	...
	$export_pdf_basic_details .="</div>";
		...
		$export_pdf_basic_details .="<tr>";
		in_array('ol_order_order_id', $advpp_settings_ol_columns) ? $export_pdf_basic_details .= "<td align='left' nowrap='nowrap' style='background-color:#fff2d0;'>".$result['order_prod_ord_id']."</td>" : '';
		...
		in_array('ol_prod_price', $advpp_settings_ol_columns) ? $export_pdf_basic_details .= "<td align='right' nowrap='nowrap' style='text-decoration:line-through;'>".$result['order_prod_price']."</td>" : '';
		}
		if ($filter_report != 'products_abandoned_orders') {
		...
		in_array('ol_prod_quantity', $advpp_settings_ol_columns) ? $export_pdf_basic_details .= "<td align='right' nowrap='nowrap' style='text-decoration:line-through;'>".$result['order_prod_quantity']."</td>" : '';
		}	
		if ($filter_report != 'products_abandoned_orders') {
		...
		in_array('ol_prod_total_excl_vat', $advpp_settings_ol_columns) ? $export_pdf_basic_details .= "<td align='right' nowrap='nowrap' style='text-decoration:line-through;'>".$result['order_prod_total_excl_vat']."</td>" : '';
		}	
		if ($filter_report != 'products_abandoned_orders') {
		...
		in_array('ol_prod_tax', $advpp_settings_ol_columns) ? $export_pdf_basic_details .= "<td align='right' nowrap='nowrap' style='text-decoration:line-through;'>".$result['order_prod_tax']."</td>" : '';
		}		
		if ($filter_report != 'products_abandoned_orders') {
		...
		in_array('ol_prod_total_incl_vat', $advpp_settings_ol_columns) ? $export_pdf_basic_details .= "<td align='right' nowrap='nowrap' style='text-decoration:line-through;'>".$result['order_prod_total_incl_vat']."</td>" : '';
		}	
		$export_pdf_basic_details .="</tr>";					
		...
		$export_pdf_basic_details .="</thead><tbody>";
		$export_pdf_basic_details .="<tr>";
		in_array('pl_prod_order_id', $advpp_settings_pl_columns) ? $export_pdf_basic_details .= "<td align='left' nowrap='nowrap' style='background-color:#fff2d0;'>".$result['product_ord_id']."</td>" : '';
		...
		in_array('pl_prod_category', $advpp_settings_pl_columns) ? $export_pdf_basic_details .= "<td align='left' nowrap='nowrap'>".$result['product_category']."</td>" : '';	
		in_array('pl_prod_manu', $advpp_settings_pl_columns) ? $export_pdf_basic_details .= "<td align='left' nowrap='nowrap'>".$result['product_manu']."</td>" : '';
		in_array('pl_prod_supplier', $advpp_settings_pl_columns) ? $export_pdf_basic_details .= "<td align='left' nowrap='nowrap'>".$result['product_supplier']."</td>" : '';
		}	
		...
		$export_pdf_basic_details .="</thead><tbody>";
		$export_pdf_basic_details .="<tr>";
		in_array('cl_customer_order_id', $advpp_settings_cl_columns) ? $export_pdf_basic_details .= "<td align='left' nowrap='nowrap' style='background-color:#fff2d0;'>".$result['customer_ord_id']."</td>" : '';
	...
	if ($filter_report == 'manufacturers' or $filter_report == 'categories') {
	in_array('cm_sold_quantity', $advpp_settings_cm_columns) ? $export_pdf_basic_details .= "<td align='right' nowrap='nowrap' class='total' style='background-color:#FFC;'>".$result['sold_quantity_total']."</td>" : '';
	in_array('cm_sold_percent', $advpp_settings_cm_columns) ? $export_pdf_basic_details .= "<td align='right' nowrap='nowrap' class='total' style='background-color:#FFC;'>".$result['sold_percent_total']."</td>" : '';
	in_array('cm_total_excl_vat', $advpp_settings_cm_columns) ? $export_pdf_basic_details .= "<td align='right' nowrap='nowrap' class='total'>".$result['total_excl_vat_total']."</td>" : '';
	in_array('cm_total_tax', $advpp_settings_cm_columns) ? $export_pdf_basic_details .= "<td align='right' nowrap='nowrap' class='total'>".$result['total_tax_total']."</td>" : '';
	in_array('cm_total_incl_vat', $advpp_settings_cm_columns) ? $export_pdf_basic_details .= "<td align='right' nowrap='nowrap' class='total'>".$result['total_incl_vat_total']."</td>" : '';
	in_array('cm_app', $advpp_settings_cm_columns) ? $export_pdf_basic_details .= "<td align='right' nowrap='nowrap' class='total'>".$result['app_total']."</td>" : '';	
	in_array('cm_refunds', $advpp_settings_cm_columns) ? $export_pdf_basic_details .= "<td align='right' nowrap='nowrap' class='total'>".$result['refunds_total']."</td>" : '';	
	in_array('cm_reward_points', $advpp_settings_cm_columns) ? $export_pdf_basic_details .= "<td align='right' nowrap='nowrap' class='total'>".$result['reward_points_total']."</td>" : '';	
	} elseif ($filter_report == 'products_options') {
	...
	if ($filter_report != 'products_abandoned_orders') {
	in_array('mv_sold_quantity', $advpp_settings_mv_columns) ? $export_pdf_basic_details .= "<td align='right' nowrap='nowrap' class='total' style='background-color:#FFC;'>".$result['sold_quantity_total']."</td>" : '';
	} else {
	in_array('mv_sold_quantity', $advpp_settings_mv_columns) ? $export_pdf_basic_details .= "<td align='right' nowrap='nowrap' class='total' style='background-color:#FFC; text-decoration:line-through;'>".$result['sold_quantity_total']."</td>" : '';		
	}
	if ($filter_report != 'products_abandoned_orders') {
	in_array('mv_sold_percent', $advpp_settings_mv_columns) ? $export_pdf_basic_details .= "<td align='right' nowrap='nowrap' class='total' style='background-color:#FFC;'>".$result['sold_percent_total']."</td>" : '';
	} else {
	in_array('mv_sold_percent', $advpp_settings_mv_columns) ? $export_pdf_basic_details .= "<td align='right' nowrap='nowrap' class='total' style='background-color:#FFC; text-decoration:line-through;'>".$result['sold_percent_total']."</td>" : '';		
	}	
	if ($filter_report != 'products_abandoned_orders') {
	...
	in_array('mv_total_excl_vat', $advpp_settings_mv_columns) ? $export_pdf_basic_details .= "<td align='right' nowrap='nowrap' class='total' style='text-decoration:line-through;'>".$result['total_excl_vat_total']."</td>" : '';	
	}	
	if ($filter_report != 'products_abandoned_orders') {
	...
	in_array('mv_total_tax', $advpp_settings_mv_columns) ? $export_pdf_basic_details .= "<td align='right' nowrap='nowrap' class='total' style='text-decoration:line-through;'>".$result['total_tax_total']."</td>" : '';
	}
	if ($filter_report != 'products_abandoned_orders') {
	...
	in_array('mv_total_incl_vat', $advpp_settings_mv_columns) ? $export_pdf_basic_details .= "<td align='right' nowrap='nowrap' class='total' style='text-decoration:line-through;'>".$result['total_incl_vat_total']."</td>" : '';
	}
	if ($filter_report != 'products_abandoned_orders') {
	...
	in_array('mv_app', $advpp_settings_mv_columns) ? $export_pdf_basic_details .= "<td align='right' nowrap='nowrap' class='total' style='text-decoration:line-through;'>".$result['app_total']."</td>" : '';	
	}
	if ($filter_report != 'products_abandoned_orders') {
	...
	in_array('mv_refunds', $advpp_settings_mv_columns) ? $export_pdf_basic_details .= "<td align='right' nowrap='nowrap' class='total' style='text-decoration:line-through;'>".$result['refunds_total']."</td>" : '';	
	}
	if ($filter_report != 'products_abandoned_orders') {
	...
	in_array('mv_reward_points', $advpp_settings_mv_columns) ? $export_pdf_basic_details .= "<td align='right' nowrap='nowrap' class='total' style='text-decoration:line-through;'>".$result['reward_points_total']."</td>" : '';	
	}
	}
	$export_pdf_basic_details .="</tr></tbody></table>";
	$export_pdf_basic_details .="</div>";
	...
	if (!isset($_GET['cron'])) {
		...
		$dompdf->render();
		$dompdf->stream("products_report_basic_details_".date($this->config->get('advpp' . $user_id . '_hour_format') == '24' ? "Y-m-d_H-i-s" : "Y-m-d_h-i-s-A").".pdf");	
