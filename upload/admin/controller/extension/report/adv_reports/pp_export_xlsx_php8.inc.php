<?php
	...
	$sheet->setTitle('ADV Products Report');
	...
	if ($export_logo_criteria ? $this->mainCounter = 2 : $this->mainCounter = 1) {
		 ...
		 if (in_array('scw_id', $advpp_settings_scw_columns)) {
		 $col = \PhpOffice\PhpSpreadsheet\Cell\Coordinate::stringFromColumnIndex($j++);		 
		 $sheet->setCellValue($col . $this->mainCounter, $this->language->get('column_id'));
		 $sheet->getStyle($col . $this->mainCounter)->getFont()->setBold(true);		 
		 $sheet->getColumnDimension($col)->setAutoSize(true);	
		 }
		 if (in_array('scw_name', $advpp_settings_scw_columns)) {
		 $col = \PhpOffice\PhpSpreadsheet\Cell\Coordinate::stringFromColumnIndex($j++);			 
		 ...
		 if (in_array('scw_model', $advpp_settings_scw_columns)) {
		 $col = \PhpOffice\PhpSpreadsheet\Cell\Coordinate::stringFromColumnIndex($j++);	
		 $sheet->setCellValue($col . $this->mainCounter, $this->language->get('column_model'));
		 $sheet->getStyle($col . $this->mainCounter)->getFont()->setBold(true);
		 $sheet->getColumnDimension($col)->setAutoSize(true);
		 }
		 if (in_array('scw_category', $advpp_settings_scw_columns)) {
		 $col = \PhpOffice\PhpSpreadsheet\Cell\Coordinate::stringFromColumnIndex($j++);	
		 $sheet->setCellValue($col . $this->mainCounter, $this->language->get('column_category'));
		 $sheet->getStyle($col . $this->mainCounter)->getFont()->setBold(true);
		 $sheet->getColumnDimension($col)->setAutoSize(true);
		 }		  
		 if (in_array('scw_manufacturer', $advpp_settings_scw_columns)) {
		 $col = \PhpOffice\PhpSpreadsheet\Cell\Coordinate::stringFromColumnIndex($j++);	
		 ...
		 if (in_array('scw_status', $advpp_settings_scw_columns)) {
		 $col = \PhpOffice\PhpSpreadsheet\Cell\Coordinate::stringFromColumnIndex($j++);	
		 ...
		 if (in_array('scw_stock_quantity', $advpp_settings_scw_columns)) {
		 $col = \PhpOffice\PhpSpreadsheet\Cell\Coordinate::stringFromColumnIndex($j++);	
		 ...
		 if ($filter_report == 'products_shopping_carts') {
		 if (in_array('scw_cart_quantity', $advpp_settings_scw_columns)) {
		 $col = \PhpOffice\PhpSpreadsheet\Cell\Coordinate::stringFromColumnIndex($j++);	
		 ...
		 if (in_array('scw_wishlist_quantity', $advpp_settings_scw_columns)) {
		 $col = \PhpOffice\PhpSpreadsheet\Cell\Coordinate::stringFromColumnIndex($j++);	
		 ...
		 if (in_array('pnp_id', $advpp_settings_pnp_columns)) {
		 $col = \PhpOffice\PhpSpreadsheet\Cell\Coordinate::stringFromColumnIndex($j++);		 
		 $sheet->setCellValue($col . $this->mainCounter, $this->language->get('column_id'));
		 $sheet->getStyle($col . $this->mainCounter)->getFont()->setBold(true);			 
		 $sheet->getColumnDimension($col)->setAutoSize(true);	
		 }
		 if (in_array('pnp_name', $advpp_settings_pnp_columns)) {
		 $col = \PhpOffice\PhpSpreadsheet\Cell\Coordinate::stringFromColumnIndex($j++);			 
		 $sheet->setCellValue($col . $this->mainCounter, $this->language->get('column_pname'));
		 $sheet->getStyle($col . $this->mainCounter)->getFont()->setBold(true);
		 $sheet->getColumnDimension($col)->setAutoSize(true);	
		 ...
		 if (in_array('pnp_model', $advpp_settings_pnp_columns)) {
		 $col = \PhpOffice\PhpSpreadsheet\Cell\Coordinate::stringFromColumnIndex($j++);	
		 $sheet->setCellValue($col . $this->mainCounter, $this->language->get('column_model'));
		 $sheet->getStyle($col . $this->mainCounter)->getFont()->setBold(true);
		 $sheet->getColumnDimension($col)->setAutoSize(true);
		 }
		 if (in_array('pnp_category', $advpp_settings_pnp_columns)) {
		 $col = \PhpOffice\PhpSpreadsheet\Cell\Coordinate::stringFromColumnIndex($j++);	
		 $sheet->setCellValue($col . $this->mainCounter, $this->language->get('column_category'));
		 $sheet->getStyle($col . $this->mainCounter)->getFont()->setBold(true);
		 $sheet->getColumnDimension($col)->setAutoSize(true);
		 }		  
		 if (in_array('pnp_manufacturer', $advpp_settings_pnp_columns)) {
		 $col = \PhpOffice\PhpSpreadsheet\Cell\Coordinate::stringFromColumnIndex($j++);	
		 $sheet->setCellValue($col . $this->mainCounter, $this->language->get('column_manufacturer'));
		 $sheet->getStyle($col . $this->mainCounter)->getFont()->setBold(true);
		 $sheet->getColumnDimension($col)->setAutoSize(true);
		 ...
		 if (in_array('pnp_status', $advpp_settings_pnp_columns)) {
		 $col = \PhpOffice\PhpSpreadsheet\Cell\Coordinate::stringFromColumnIndex($j++);	
		 $sheet->setCellValue($col . $this->mainCounter, $this->language->get('column_status'));
		 $sheet->getStyle($col . $this->mainCounter)->getFont()->setBold(true);
		 $sheet->getColumnDimension($col)->setAutoSize(true);
		 ...
		 if (in_array('pnp_stock_quantity', $advpp_settings_pnp_columns)) {
		 $col = \PhpOffice\PhpSpreadsheet\Cell\Coordinate::stringFromColumnIndex($j++);	
		 $sheet->setCellValue($col . $this->mainCounter, $this->language->get('column_stock_quantity'));
		 $sheet->getStyle($col . $this->mainCounter)->getFont()->setBold(true);
		 $sheet->getStyle($col . $this->mainCounter)->getAlignment()->setHorizontal(\PhpOffice\PhpSpreadsheet\Style\Alignment::HORIZONTAL_RIGHT);		 
		 ...
		 if (in_array('cm_orders', $advpp_settings_cm_columns)) {
		 $col = \PhpOffice\PhpSpreadsheet\Cell\Coordinate::stringFromColumnIndex($j++);	
		 ...
		 if (in_array('cm_sold_quantity', $advpp_settings_cm_columns)) {
		 $col = \PhpOffice\PhpSpreadsheet\Cell\Coordinate::stringFromColumnIndex($j++);	
		 ...
		 if (in_array('cm_sold_percent', $advpp_settings_cm_columns)) {
		 $col = \PhpOffice\PhpSpreadsheet\Cell\Coordinate::stringFromColumnIndex($j++);	
		 ...
		 if (in_array('cm_total_excl_vat', $advpp_settings_cm_columns)) {
		 $col = \PhpOffice\PhpSpreadsheet\Cell\Coordinate::stringFromColumnIndex($j++);	
		 ...
		 if (in_array('cm_total_tax', $advpp_settings_cm_columns)) {
		 $col = \PhpOffice\PhpSpreadsheet\Cell\Coordinate::stringFromColumnIndex($j++);	
		 ...
		 if (in_array('cm_total_incl_vat', $advpp_settings_cm_columns)) {
		 $col = \PhpOffice\PhpSpreadsheet\Cell\Coordinate::stringFromColumnIndex($j++);	
		 ...
		 if (in_array('cm_app', $advpp_settings_cm_columns)) {
		 $col = \PhpOffice\PhpSpreadsheet\Cell\Coordinate::stringFromColumnIndex($j++);	
		 ...
		 if (in_array('cm_refunds', $advpp_settings_cm_columns)) {
		 $col = \PhpOffice\PhpSpreadsheet\Cell\Coordinate::stringFromColumnIndex($j++);	
		 ...
		 if (in_array('mv_orders', $advpp_settings_mv_columns)) {
		 $col = \PhpOffice\PhpSpreadsheet\Cell\Coordinate::stringFromColumnIndex($j++);	
		 $sheet->setCellValue($col . $this->mainCounter, $this->language->get('column_orders'));
		 $sheet->getStyle($col . $this->mainCounter)->getFont()->setBold(true);
		 $sheet->getStyle($col . $this->mainCounter)->getAlignment()->setHorizontal(\PhpOffice\PhpSpreadsheet\Style\Alignment::HORIZONTAL_RIGHT);		 
		 ...
		 if ($export_logo_criteria) {
			...
			$sheet->setCellValue('C1', $this->language->get('text_report_date').": ".date($this->config->get('advpp' . $user_id . '_hour_format') == '24' ? "Y-m-d H:i:s" : "Y-m-d h:i:s A"));
	...
	foreach ($results as $result) {	
		...
		if (in_array('mv_orders', $advpp_settings_cm_columns)) {
		$col = \PhpOffice\PhpSpreadsheet\Cell\Coordinate::stringFromColumnIndex($j++);				
		$sheet->setCellValue($col . $counter, $result['orders']);
		}
		if (in_array('mv_customers', $advpp_settings_cm_columns)) {
		$col = \PhpOffice\PhpSpreadsheet\Cell\Coordinate::stringFromColumnIndex($j++);				
		$sheet->setCellValue($col . $counter, $result['customers']);
		}
