<?php
	...
	if ($results) {
		...
		in_array('scw_upc', $advpp_settings_scw_columns) ? $worksheet->setColumn($j,$j++,15) : ''; 
		in_array('scw_ean', $advpp_settings_scw_columns) ? $worksheet->setColumn($j,$j++,15) : ''; 
		in_array('scw_jan', $advpp_settings_scw_columns) ? $worksheet->setColumn($j,$j++,15) : ''; 
		in_array('scw_isbn', $advpp_settings_scw_columns) ? $worksheet->setColumn($j,$j++,15) : ''; 
		in_array('scw_mpn', $advpp_settings_scw_columns) ? $worksheet->setColumn($j,$j++,15) : ''; 
		...
		in_array('pnp_upc', $advpp_settings_pnp_columns) ? $worksheet->setColumn($j,$j++,15) : ''; 
		in_array('pnp_ean', $advpp_settings_pnp_columns) ? $worksheet->setColumn($j,$j++,15) : ''; 
		in_array('pnp_jan', $advpp_settings_pnp_columns) ? $worksheet->setColumn($j,$j++,15) : ''; 
		in_array('pnp_isbn', $advpp_settings_pnp_columns) ? $worksheet->setColumn($j,$j++,15) : ''; 
		in_array('pnp_mpn', $advpp_settings_pnp_columns) ? $worksheet->setColumn($j,$j++,15) : ''; 
		...
		in_array('scw_upc', $advpp_settings_scw_columns) ? $worksheet->writeString($i, $j++, $this->language->get('column_upc'), $boxFormatText) : '';
		in_array('scw_ean', $advpp_settings_scw_columns) ? $worksheet->writeString($i, $j++, $this->language->get('column_ean'), $boxFormatText) : '';
		in_array('scw_jan', $advpp_settings_scw_columns) ? $worksheet->writeString($i, $j++, $this->language->get('column_jan'), $boxFormatText) : '';
		in_array('scw_isbn', $advpp_settings_scw_columns) ? $worksheet->writeString($i, $j++, $this->language->get('column_isbn'), $boxFormatText) : '';
		in_array('scw_mpn', $advpp_settings_scw_columns) ? $worksheet->writeString($i, $j++, $this->language->get('column_mpn'), $boxFormatText) : '';
		...
		in_array('pnp_upc', $advpp_settings_pnp_columns) ? $worksheet->writeString($i, $j++, $this->language->get('column_upc'), $boxFormatText) : '';
		in_array('pnp_ean', $advpp_settings_pnp_columns) ? $worksheet->writeString($i, $j++, $this->language->get('column_ean'), $boxFormatText) : '';
		in_array('pnp_jan', $advpp_settings_pnp_columns) ? $worksheet->writeString($i, $j++, $this->language->get('column_jan'), $boxFormatText) : '';
		in_array('pnp_isbn', $advpp_settings_pnp_columns) ? $worksheet->writeString($i, $j++, $this->language->get('column_isbn'), $boxFormatText) : '';
		in_array('pnp_mpn', $advpp_settings_pnp_columns) ? $worksheet->writeString($i, $j++, $this->language->get('column_mpn'), $boxFormatText) : '';
		...
		$j = 0;
			...
			$excelRow = $i+1;
				...
				in_array('scw_upc', $advpp_settings_scw_columns) ? $worksheet->write($i, $j++, $result['upc'], $textFormat) : '';
				in_array('scw_ean', $advpp_settings_scw_columns) ? $worksheet->write($i, $j++, $result['ean'], $textFormat) : '';
				in_array('scw_jan', $advpp_settings_scw_columns) ? $worksheet->write($i, $j++, $result['jan'], $textFormat) : '';
				in_array('scw_isbn', $advpp_settings_scw_columns) ? $worksheet->write($i, $j++, $result['isbn'], $textFormat) : '';
				in_array('scw_mpn', $advpp_settings_scw_columns) ? $worksheet->write($i, $j++, $result['mpn'], $textFormat) : '';
				...
				$c = $j;
				in_array('scw_customer_id', $advpp_settings_scw_columns) ? $worksheet->write($i, $j++, $customer['customer_id'], $textFormat) : '';
				...
				in_array('pnp_upc', $advpp_settings_pnp_columns) ? $worksheet->write($i, $j++, $result['upc'], $textFormat) : '';
				in_array('pnp_ean', $advpp_settings_pnp_columns) ? $worksheet->write($i, $j++, $result['ean'], $textFormat) : '';
				in_array('pnp_jan', $advpp_settings_pnp_columns) ? $worksheet->write($i, $j++, $result['jan'], $textFormat) : '';
				in_array('pnp_isbn', $advpp_settings_pnp_columns) ? $worksheet->write($i, $j++, $result['isbn'], $textFormat) : '';
				in_array('pnp_mpn', $advpp_settings_pnp_columns) ? $worksheet->write($i, $j++, $result['mpn'], $textFormat) : '';
