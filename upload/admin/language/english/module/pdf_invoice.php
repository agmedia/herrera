...
$_['entry_adminlanguage']			= 'Packing slip language:<span class="help">Use a specific language for packing slip files.</span>';
$_['entry_forcelanguage']			= 'Force invoice language:<span class="help">Some values are inserted in database during order confirmation, so it cannot be translated on-the-fly. Use this option to force the invoice in the language of your choice.</span>';
...
$_['entry_refund_invoice']		= 'Correction invoice:<span class="help">Set correction invoice (reversed amount) in case the order reach these statuses</span>';
...
$_['entry_date_invoice']	  = 'Auto set order date:<span class="help">Set the order date to the date when invoice number is generated</span>';
...
$_['entry_template_group']		= 'Template for customer group:<span class="help">If you want to use different template for each customer group you can choose it here</span>';
$_['text_template_use_main']	= 'Use main template';
...
$_['entry_col_attributes']	= 'Attributes';
$_['entry_col_attribute_group']	= 'Attributes (by group)';
...
$_['entry_col_special_percent'] = 'Spec/disc.';
...
$_['entry_block_display']				= 'Filter:';
$_['entry_block_inline']				= 'Display in block:';
...
<span><b class="tag">{order_history}</b> Order history table</span>
