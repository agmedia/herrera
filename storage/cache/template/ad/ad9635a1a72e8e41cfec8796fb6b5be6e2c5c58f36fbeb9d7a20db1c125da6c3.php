...
class __TwigTemplate_2b5578259bfd07ce73a6221d7217aa84122daf02170db732230ab8626ae7bde8 extends \Twig\Template
{
    private $source;
    private $macros = [];
...
<style type=\"text/css\">
  ...
  .mpgdpr-cookie { padding: 15px 25px; background: rgb(0, 161, 157); color: #fff;  margin: auto;  overflow-y: auto; position: fixed; left:15px;bottom:200px}
  .mpgdpr-cookie .mpgdpr-container { margin: auto; }
  .mpgdpr-cookie .mpgdpr-text{ display: block; vertical-align: top; }
  .mpgdpr-cookie .set-btns{ display: block; text-align: center; margin-top: 25px;margin-bottom:25px }
  .mpgdpr-cookie .mcookie-btn{ border: none; padding: 10px 15px; cursor: pointer;  background: #e05d5d; color: #fff; display: inline-block;  margin-right: 10px}
