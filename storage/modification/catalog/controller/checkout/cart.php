...
if(file_exists('catalog/model/extension/cmpltguagaf.php')) { 
				...
				$data['footer'] .= $this->model_extension_cmpltguagaf->viewcart();
			}
...
if(file_exists('catalog/model/extension/cmpltguagaf.php')) { 
				$this->load->model('extension/cmpltguagaf');
				$json['total'] .= $this->model_extension_cmpltguagaf->atcw($this->request->post['product_id'], $quantity, 1);
			}
			} else {
...
if(file_exists('catalog/model/extension/cmpltguagaf.php')) { 
				$this->load->model('extension/cmpltguagaf');
				$json['total'] .= $this->model_extension_cmpltguagaf->rmc($this->request->post['key']);
			}
		}
